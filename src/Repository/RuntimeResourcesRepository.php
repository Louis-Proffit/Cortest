...
class RuntimeResourcesRepository
{
    ...
    public function etalonnageComputerPath(DefinitionEtalonnageComputer $definition): string
    {
        return $this->path(getcwd(), $this->etalonnage_computer_folder, $definition->nom_php);
    }

    public function etalonnageComputerExists(DefinitionEtalonnageComputer $definition): bool
    {
        return $this->fileExists(getcwd(), $this->etalonnage_computer_folder, $definition->nom_php);
    }

    public function etalonnageComputer(DefinitionEtalonnageComputer $definition): EtalonnageComputer
    {
    ...
    {
        return $root_folder . "/Res/" . $specific_folder . "/" . $nom_php . ".php";
    }
