 ...
 */
final class Version20220924174720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE epreuve (id INT NOT NULL, code_epreuve SMALLINT NOT NULL, PRIMARY KEY(id))');
    }
